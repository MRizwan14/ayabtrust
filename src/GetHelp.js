...
class GetHelp extends Component {
  ...
  handleFormValidation() {
    ...
    if (!noh) {
      formIsValid = false;
      formErrors["nohErr"] = "Nature of Help is required.";
    }
  ...
  handleSubmit = (e) => {
    ...
    axios
      .post("http://localhost:5000/gethelp/add", this.state)
  ...
  render() {
    ...
    return (
      <div className="container formDiv">
        <h3 style={{ textAlign: "center" }}>Get Help</h3>
        <div>
          <form onSubmit={this.handleSubmit}>
            <div className="row">
              ...
              <div className="">
                <label htmlFor="noh">Nature Of Help Required</label>
                <input
                  type="text"
                  name="noh"
                  value={this.state.noh}
                  onChange={this.handleChange}
                  placeholder="Nature Of Help Required"
                  className={nohErr ? " showError" : ""}
                />
                {nohErr && (
                  <div style={{ color: "red", paddingBottom: 10 }}>
                    {nohErr}
